...
class PSNL(nn.Module):
    def __init__(self, channels,reduction):
        ...
        # nonlocal module
        self.non_local = NONLocalBlock2D(channels,reduction=reduction)
...
class AWAN(nn.Module):
    def __init__(self, inplanes=3, planes=31,reduction=4, channels=200, n_DRBs=8):
        ...
        self.tail_nonlocal = PSNL(planes,reduction=reduction)
